...
bot.on("message", function(user, userID, channelID, message, rawEvent) {
    ...
    if(triggerCheck == trigger || userID === bot.id){
        console.log(colors.yellow("Server ID: " + bot.serverFromChannel(channelID)));
...
function reload(cI) {
     ...
     try {
        ...
        commands = Object.assign({}, admin, help, info, calc, color);
